...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Doubt.datepost'
        db.add_column(u'baygon_doubt', 'datepost',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 26, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Answer.datepost'
        db.add_column(u'baygon_answer', 'datepost',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 26, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Doubt.datepost'
        db.delete_column(u'baygon_doubt', 'datepost')

        # Deleting field 'Answer.datepost'
        db.delete_column(u'baygon_answer', 'datepost')
