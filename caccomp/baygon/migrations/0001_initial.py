...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Doubt'
        db.create_table(u'baygon_doubt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('asking', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('explanation', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
        ...
        db.send_create_signal(u'baygon', ['Doubt'])

        # Adding model 'Answer'
        db.create_table(u'baygon_answer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('explanation', self.gf('django.db.models.fields.TextField')()),
            ('code', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('popularity', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('academic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Academic'])),
            ('doubt', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['baygon.Doubt'])),
        ))
        db.send_create_signal(u'baygon', ['Answer'])


    def backwards(self, orm):
        # Deleting model 'Doubt'
        db.delete_table(u'baygon_doubt')

        # Deleting model 'Answer'
        db.delete_table(u'baygon_answer')
